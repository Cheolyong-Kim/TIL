...
![graph_1](데이터 시각화 03.assets/graph_1.png)
...
![graph_2](데이터 시각화 03.assets/graph_2.png)
...
![graph_3](데이터 시각화 03.assets/graph_3.png)
...
![graph_4](데이터 시각화 03.assets/graph_4.png)
...
![graph_5](데이터 시각화 03.assets/graph_5.png)
...
![graph_6](데이터 시각화 03.assets/graph_6.png)
...
![graph_7](데이터 시각화 03.assets/graph_7.png)
...
![graph_8](데이터 시각화 03.assets/graph_8.png)
...
![graph_9](데이터 시각화 03.assets/graph_9.png)
...
![graph_10](데이터 시각화 03.assets/graph_10.png)
...
![graph_11](데이터 시각화 03.assets/graph_11.png)
...
![graph_12](데이터 시각화 03.assets/graph_12.png)
...
![graph_13](데이터 시각화 03.assets/graph_13.png)
...
![graph_14](데이터 시각화 03.assets/graph_14.png)
...
![graph_15](데이터 시각화 03.assets/graph_15.png)
...
![graph_16](데이터 시각화 03.assets/graph_16.png)
...
![graph_17](데이터 시각화 03.assets/graph_17.png)
...
![graph_18](데이터 시각화 03.assets/graph_18.png)
...
![graph_19](데이터 시각화 03.assets/graph_19.png)
...
![graph_20](데이터 시각화 03.assets/graph_20.png)
...
![graph_21](데이터 시각화 03.assets/graph_21.png)
...
![graph_22](데이터 시각화 03.assets/graph_22.png)
...
![graph_23](데이터 시각화 03.assets/graph_23.png)
...
![graph_24](데이터 시각화 03.assets/graph_24.png)
...
![graph_25](데이터 시각화 03.assets/graph_25.png)
...
![graph_26](데이터 시각화 03.assets/graph_26.png)
...
![graph_27](데이터 시각화 03.assets/graph_27.png)
...
![graph_28](데이터 시각화 03.assets/graph_28.png)
...
![graph_29](데이터 시각화 03.assets/graph_29.png)
...
![graph_30](데이터 시각화 03.assets/graph_30.png)
...
![graph_31](데이터 시각화 03.assets/graph_31.png)
...
![graph_32](데이터 시각화 03.assets/graph_32.png)
...
![graph_33](데이터 시각화 03.assets/graph_33.png)
...
![graph_34](데이터 시각화 03.assets/graph_34.png)
...
![graph_35](데이터 시각화 03.assets/graph_35.png)
...
![graph_36](데이터 시각화 03.assets/graph_36.png)
...
![graph_37](데이터 시각화 03.assets/graph_37.png)
...
![graph_38](데이터 시각화 03.assets/graph_38.png)
...
![graph_39](데이터 시각화 03.assets/graph_39.png)
...
![graph_40](데이터 시각화 03.assets/graph_40.png)
...
1. 파일에서 연도별 음주교통사고 발생횟수와 연도별 부상인원수를 꺾은선 그래프로 표시
   ...
   ![graph_41](데이터 시각화 03.assets/graph_41.png)
...
2. 같은 파일에서 연도별 음주교통사고 사망인원을 막대 그래프로 표시
   ...
   ![graph_42](데이터 시각화 03.assets/graph_42.png)
...
3. 같은 파일에서 연도별 음주교통사고 사망인원을 사망인원을 x축으로 누적막대그래프로 표시
   ...
   ![graph_43](데이터 시각화 03.assets/graph_43.png)
...
4. 같은 파일에서 연도별 음주교통사고 사망인원, 발생횟수, 부상인원을 각각 누적막대그래프로 표시
   ...
   ![graph_44](데이터 시각화 03.assets/graph_44.png)
...
5. 엑셀파일에서 영화명과 누적매출액에 대한 막대그래프와 영화명과 누적관객수에 대한 막대그래프 표시
   ...
   ![graph_45](데이터 시각화 03.assets/graph_45.png)

![graph_46](데이터 시각화 03.assets/graph_46.png)
...
![graph_47](데이터 시각화 03.assets/graph_47.png)